[elastalink-3f10-ai] Operating Details
====================================

Generated On: 2025-02-11 14:18:26 UTC
...
.. important::
   ...
   **not be valid if your [elastalink-3f10-ai] container is NOT running**.

.. tip::
   You must have your [elastalink-3f10-ai] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   maadsdocker/elastalink-3f10-ai-amd64 (https://hub.docker.com/r/maadsdocker/elastalink-3f10-ai-amd64)
...
.. code-block::
   ...
   docker run -d -p 5050:5050 -p 4040:4040 -p 6060:6060 \
          --env TSS=0 \
          --env SOLUTIONNAME=elastalink-3f10-ai \
          --env SOLUTIONDAG=solution_preprocessing_ai_dag-elastalink-3f10 \
          ...
          maadsdocker/elastalink-3f10-ai-amd64
...
[elastalink-3f10-ai] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/elastalink-3f10-ai
...
.. important::
   https://elastalink-3f10-ai.readthedocs.io
...
.. important::
   solution_preprocessing_ai_dag-elastalink-3f10
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=45017, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=46117, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=40123, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=37511, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=33855, HPDEHOST=127.0.1.1, HPDEPORT=38159, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=38779

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-4453-elastalink-3f10-ai,solution_preprocessing_ai_dag-elastalink-3f10, python-preprocess-8769-elastalink-3f10-ai,solution_preprocessing_ai_dag-elastalink-3f10, python-ai-968-elastalink-3f10-ai,solution_preprocessing_ai_dag-elastalink-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
